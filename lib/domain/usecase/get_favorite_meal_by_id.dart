...
class GetFavoriteMealById extends UseCase<List<MealEntity>, String> {
  final MealRepository mealRepository;
  GetFavoriteMealById({required this.mealRepository});
  
  @override
  Future<Either<Failure, List<MealEntity>>> call(String params)async {
    return await mealRepository.getCachedMealById(params);
  }
